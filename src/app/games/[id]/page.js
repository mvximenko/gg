  ...
  return (
    <>
      <Background classes='blur-sm h-[450px]' gradientClass='game-gradient'>
        <CustomImage imageId={screenshots?.[0]?.image_id} noFallback />
      </Background>

      <div className='px-4 sm:px-10 mb-20 mt-24 grid grid-cols-[0.25fr_1fr] gap-6'>
        <div>
        ...
        <div>
          ...
          <div className='mt-4 grid grid-rows-2 sm:grid-cols-5 gap-2'>
